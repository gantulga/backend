...
class User_Profile(Modifiedinfo): 
	...
	near_people_address = models.CharField(blank=True, null=True, max_length=255)
	...
	avatar = models.ImageField(upload_to='user_avatars/%Y%m%d%H%H%S', blank=True, null=True)
